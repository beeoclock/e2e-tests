        ...
        switch (caseEnum) {
            ...
            case TestCaseEnum.CASE_3:
                return {
                    ...
                    minute: null,
                    price: '150',
                    summary: ServiceNameEnum.BREAD_TRIM + "\nPL\n⏰ " + Data + "   12:00\n⏳" +  " 15min" + " e e e2e 150,00 zł 👤 Anonimowy",
                    paymentMethod: PaymentOptionEnum.CARD,
            ...
            case TestCaseEnum.CASE_4:
                return {
                    ...
                    minute: '2',
                    price: '475',
                    summary: ServiceNameEnum.E2E_HAIRCUT.toLowerCase() + " PL ⏰ " + Data + " 15:00 ⏳ 2g, 2min e e e2e 475,00 zł 👤 Anonimowy",
                    paymentMethod: PaymentOptionEnum.CASH,
