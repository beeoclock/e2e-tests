import {LandingBizHeaderPage} from "./header/LandingBizHeaderPage";
import {LandingBizServicePage} from "./services/LandingBizServicePage";
...
import {LandingBizDemoSection} from "./demo/LandingBizDemoSection";

export class BizLandingPages {

    public static LandingBizHeaderPage: LandingBizHeaderPage = new LandingBizHeaderPage()
    public static LandingBizServicePage: LandingBizServicePage = new LandingBizServicePage()
    ...
    public static LandingBizDemoSection: LandingBizDemoSection = new LandingBizDemoSection()
}