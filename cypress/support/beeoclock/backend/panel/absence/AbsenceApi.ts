...
export class AbsenceApi {
    ...
    public static getAllAbsenceIds(): any {
        ...
        const url: string = DevEntryPointEnum.API_ENTRY_POINT + '/absence/paged?orderBy=createdAt&orderDir=desc&page=1&pageSize=2000';
        return cy.request({
            method: 'GET',
            url: url,
            headers: {
    ...
    public static deleteAbsenceWithGivenId(id: string): any {
        ...
        return cy.request({
            method: 'DELETE',
            url: DevEntryPointEnum.API_ENTRY_POINT + '/absence/' + id,
            headers: {
                'X-Business-Tenant-Id': BackendCommonEnum.X_Business_Tenant_Id,
