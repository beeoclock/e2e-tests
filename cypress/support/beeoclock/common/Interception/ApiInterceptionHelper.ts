...
export class ApiInterceptionHelper {
    ...
    public static getService(): string {
        ...
        cy.intercept('GET', DevEntryPointEnum.API_ENTRY_POINT + '/service/paged?*').as(alias);
        return alias
    }
    ...
    public static getGivenClient(clientName: string): string {
        ...
        cy.intercept('GET', DevEntryPointEnum.API_ENTRY_POINT + '/client/' + clientName).as(getGivenClient);
    ...
    public static createServicePayment(): string {
        ...
        cy.intercept('POST', DevEntryPointEnum.API_ENTRY_POINT + '/payment').as(createServicePayment);
    ...
    public static getSlot(): string {
        ...
        cy.intercept('GET', `${DevEntryPointEnum.PUBLIC_PAGE_API_ENTRY_POINT}/slot/busy?*`).as(getSlot);
        return getSlot;
    }
    ...
    public static deleteServices(): string {
        ...
        cy.intercept('PUT', DevEntryPointEnum.API_ENTRY_POINT + '/order/*').as(deleteServices);
