...
describe('api entry point UT', function () {
    ...
    it('should test prod api entry point', () => {
...
describe('tariff api entry point UT', function (): void {
    ...
    it('should test dev tariff entry point', () => {
    ...
    it('should test pre-prod tariff entry point', () => {
    ...
    it('should test prod tariff entry point', () => {
...
describe('public page api entry point UT', function (): void {
    ...
    it('should test dev public page entry point', () => {
    ...
    it('should test pre-prod public page entry point', () => {
    ...
    it('should test prod public page entry point', () => {
